        ...
        while(curr != NULL) {
            if(curr->getKey() == new_item.first) {
                ...
                if(curr->getLeft() == NULL) {
                    curr->setLeft(new AVLNode<Key, Value>(new_item.first, new_item.second, static_cast<AVLNode<Key, Value>*>(curr)));
                }
                else {
                    curr = curr->getLeft();
                }
                ...
                if(curr->getRight() == NULL) {
                    curr->setRight(new AVLNode<Key, Value>(new_item.first, new_item.second, static_cast<AVLNode<Key, Value>*>(curr)));
                }
                else {
                    curr = curr->getRight();
                }
